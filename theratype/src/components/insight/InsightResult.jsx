    ...
    <div className="max-w-4xl mx-auto space-y-12 animate-fade-in-up pb-12">
      ...
      <div className="relative">
        ...
        <Card variant="elevated" className="relative z-10 overflow-hidden border-none shadow-xl">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/3 bg-bg-surface p-8 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-border-base">
            ...
            <div className="md:w-2/3 p-8 md:p-12 flex flex-col justify-center">
              <h4 className="text-lg font-semibold text-text-muted uppercase tracking-wide mb-4">
                Profile Description
              </h4>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card variant="outlined" className="p-6">
          <h4 className="text-sm font-bold text-text-muted uppercase tracking-wide mb-6">
            Performance Metrics
          </h4>
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-4 bg-bg-surface rounded-xl">
              <div className="text-3xl font-bold text-primary-main font-mono">{avgWpm}</div>
              <div className="text-xs text-text-muted mt-1">Avg WPM</div>
            </div>
            <div className="text-center p-4 bg-bg-surface rounded-xl">
              <div className="text-3xl font-bold text-secondary-main font-mono">{avgAccuracy}%</div>
              <div className="text-xs text-text-muted mt-1">Avg Accuracy</div>
            </div>
          </div>
        </Card>
            ...
            {Object.entries(categoryCounts).map(([category, count]) => (
              <div key={category} className="flex justify-between items-center">
                ...
                <div className="flex items-center">
                  <div className="w-32 h-2 bg-bg-highlight rounded-full mr-3 overflow-hidden">
                    <div
      ...
      <div className="flex justify-center pt-8">
        <Link to="/therapy">
          <Button variant="primary" size="xl" className="shadow-xl shadow-primary-main/20 hover:shadow-primary-main/40 transform hover:-translate-y-1 transition-all">
